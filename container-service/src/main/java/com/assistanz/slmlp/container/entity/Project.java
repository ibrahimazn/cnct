...
public class Project implements Serializable {
   ...
   *
   * @param sourceRepo the new source repo
   */
   ...
   *
   * @param sourceRepoId the new source repo id
   */
   ...
   * Sets the launchers.
   *
   * @param launchers the new launchers
   */
   ...
   *
   * @param trainingEngines the new training engines
   */
   ...
   *
   * @param projectUsers the new project users
   */
   ...
   *
   * @param applicationPath the new application path
   */
   ...
   *
   * @param offlineDeployment the new offline deployment
   */
   ...
   *
   * @param offlineDeploymentId the new offline deployment id
   */
