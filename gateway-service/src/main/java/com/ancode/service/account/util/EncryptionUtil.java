...
public class EncryptionUtil {
   ...
   *           raise if error
   */
  public static synchronized String encrypt(String encryptText, SecretKey secretKey, MessageSource messageSource)
      throws Exception {
    try {
   ...
   *           raise if error
   */
  public static synchronized String decrypt(String decryptText, SecretKey secretKey, MessageSource messageSource)
      throws Exception {
    try {
   ...
   */
  public static String whmcsDecrypt(final String plaintext, String secretKey)
