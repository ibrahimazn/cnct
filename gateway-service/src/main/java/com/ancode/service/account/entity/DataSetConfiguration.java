...
public class DataSetConfiguration implements Serializable {
   ...
   *
   * @param dataSourceAuthUrl
   *          the new data source auth url
   */
   ...
   *
   * @param dataSetStorageTypes
   *          the new data set storage types
   */
   ...
   *
   * @param dataSetVersionLimit
   *          the new data set version limit
   */
   ...
   *
   * @param dataSetPublishUrl
   *          the new data set publish url
   */
   ...
   *
   * @param dataSetAuthUrl
   *          the new data set auth url
   */
   ...
   *
   * @param dataSourceAdditionalParam
   *          the new data source additional param
   */
   ...
   *
   * @param dataSetAdditionalParam
   *          the new data set additional param
   */
