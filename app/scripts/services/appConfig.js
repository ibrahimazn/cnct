...
function appConfig() {
    var appConstant = {
        ...
        UI_APP_URL: window.location.protocol + "//" + window.location.hostname + (window.location.port ? ':' + window.location.port: '') + '/slmlp-ui1/app/',
        AUTH_APP_URL: "http://localhost:9090/",
        SOCKET_URL :  "ws://"+ window.location.hostname + ":8083/",
        CURRENT_PROJECT : '/',
