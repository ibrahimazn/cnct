(function(angular) {
    'use strict';
    angular.module('slmlp').service('fileNavigator', [
        'apiMiddleware', 'fileManagerConfig', 'item', 'slmlpService', function (ApiMiddleware, fileManagerConfig, Item, slmlpService) {
        ...
        FileNavigator.prototype.folderClick = function(item) {
            ...
            if (item && item.isFolder()) {
                ...
                slmlpService.appConfig.CURRENT_PATH = item.model.fullPath();
            }
            this.refresh();
        };
