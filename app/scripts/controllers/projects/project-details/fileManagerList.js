function fileManagerListCtrl($scope, toastr, slmlpService, $http, $timeout, $rootScope, $window, $translate, fileManagerConfig, item, fileNavigator, apiMiddleware, $location, $state) {
...
//                                }, 1000);
    ...
    $scope.filerManagerDetailsObject = {
        ...
        launchEditor: function (launcher) {
            ...
            var hasResult = slmlpService.crudService.add("launcher/launch", launcher);
            hasResult.then(function (result) {
