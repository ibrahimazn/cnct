function userDashboardCtrl($scope, slmlpService, $http, toastr, $sce) {
    ...
    $scope.userDashboardObject = {
        ...
        getGrafanaUrl: function () {
            var hasResult = slmlpService.crudService.listAll("user/findactiveuser");
        ...
        getUserProject: function () {
            var hasProjects = slmlpService.crudService.listAll("project/listbyisactive");
        ...
        getActiveProjects: function () {
            var hasResult = slmlpService.crudService.listAll("project/listbyisactive");
            hasResult.then(function (result) {
        ...
        getLaunchersList: function () {
            ...
            var hasLaunchers = slmlpService.crudService.listAllByGateway("containers/container/api/deployment/findalllaunchersbyuserandtype");
...
//                }, 5000);
        ...
        getPodsList: function () {
            ...
            var hasDeployments = slmlpService.crudService.listAllByGateway("containers/container/api/deployment/findalllaunchersbyuser");
        ...
        init: function () {
            ...
            var accessToken = slmlpService.localStorageService.get("access_token");
            if (accessToken === null || angular.isUndefined(accessToken)) {
                window.location.href = slmlpService.appConfig.AUTH_APP_URL + "auth/oauth/authorize?&response_type=code&client_id=client1&redirect_uri=" + slmlpService.appConfig.UI_APP_URL + "authentication.html";
            }
