...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            livereload: {
                ...
                files: [
                    '<%= appfiss.app %>/**/*.html',
                    '.tmp/styles/{,*/}*.css',
                    '<%= appfiss.app %>/images/{,*/}*.{png,jpg,jpeg,gif,webp,svg}'
                ]
            }
        },
        ...
        filerev: {
            dist: {
                src: [
                    '<%= appfiss.dist %>/scripts/{,*/}*.js',
                    '<%= appfiss.dist %>/styles/{,*/}*.css',
                    '<%= appfiss.dist %>/styles/fonts/*'
                ]
            }
        },
        htmlmin: {
