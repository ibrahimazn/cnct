(function(angular) {
    'use strict';
    angular.module('appfiss').service('fileNavigator', [
        'apiMiddleware', 'fileManagerConfig', 'item', 'appfissService', function (ApiMiddleware, fileManagerConfig, Item, appfissService) {
        ...
        // $rootScope.selectedPath = FileNavigator.currentPath;
        ...
        FileNavigator.prototype.listByPath = function(path) {
            return this.apiMiddleware.listbyPath(path, this.deferredHandler.bind(this));
        };
        ...
        FileNavigator.prototype.refresh = function() {
            ...
            self.fileList = [];
            return self.list().success(function(data) {
        ...
        FileNavigator.prototype.showCurrentPath = function(path) {
            var self = this;
            if (! self.currentPath.length) {
        ...
        FileNavigator.prototype.folderClick = function(item) {
            ...
            if (item && item.isFolder()) {
                ...
                appfissService.appConfig.CURRENT_PATH = item.model.fullPath();
            }
            this.refresh();
        };
