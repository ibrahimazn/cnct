(function(angular) {
    'use strict';
    angular.module('appfiss').service('apiMiddleware', ['$window', 'fileManagerConfig', 'apiHandler',
        ...
        ApiMiddleware.prototype.listbyPath = function(path, customDeferredHandler) {
