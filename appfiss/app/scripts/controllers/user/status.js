function statusCtrl($scope, appfissService, $http, $timeout, toastr, $state, $location) {
    ...
    $scope.filerManagerDetailsObject = {
        ...
        getBranchList: function () {
            var hasList = appfissService.crudService.PostViaGateway("containers/container/api/files/branches", $scope.gitObject);
            var results = [];
