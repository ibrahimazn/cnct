    ...
    return {
        link: function (scope, element) {
            var listener = function (event, toState, toParams, fromState, fromParams) {
                ...
                var title = 'AppFiss - Serverless ML Management App';
                // Create your own title pattern
                if (toState.data && toState.data.pageTitle)
                    title = 'AppFiss | ' + toState.data.pageTitle;
                $timeout(function () {
                    element.text(title);
                });
            };
...
angular
        ...
        .directive('angularFilemanager', ['$parse', 'fileManagerConfig', 'appfissService', function ($parse, fileManagerConfig, appfissService) {
                return {
                    restrict: 'EA',
                    templateUrl: fileManagerConfig.tplPath + '/main.html'
                };
            }])
        .directive('angularFilemanagerData', ['$parse', '$timeout', 'fileManagerConfig', 'appfissService', function ($parse, $timeout, fileManagerConfig, appfissService) {
                    return {
                        restrict: 'EA',
